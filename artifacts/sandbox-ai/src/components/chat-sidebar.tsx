        ...
        >
          ...
          <div className="px-3 pt-3 pb-2 shrink-0">
            ...
            <div className="mt-2 space-y-1.5">
              <p className="px-1 text-[9px] uppercase tracking-widest font-bold" style={{ color: "rgba(255,255,255,0.18)" }}>Create</p>
              <Link href="/templates" onClick={onClose}>
                <div
                  ...
                  style={{ background: "rgba(168,85,247,0.07)", color: "rgba(168,85,247,0.85)", border: "1px solid rgba(168,85,247,0.2)" }}
                  onMouseEnter={e => { e.currentTarget.style.background = "rgba(168,85,247,0.15)"; e.currentTarget.style.color = "#a855f7"; e.currentTarget.style.borderColor = "rgba(168,85,247,0.4)"; }}
                  onMouseLeave={e => { e.currentTarget.style.background = "rgba(168,85,247,0.07)"; e.currentTarget.style.color = "rgba(168,85,247,0.85)"; e.currentTarget.style.borderColor = "rgba(168,85,247,0.2)"; }}
                >
                  <div className="w-5 h-5 rounded-md flex items-center justify-center shrink-0 text-[11px]" style={{ background: "rgba(168,85,247,0.18)" }}>⚡</div>
                  <span>Remix a Template</span>
                </div>
              </Link>
              <Link href="/import-github" onClick={onClose}>
                <div
                  className="w-full flex items-center gap-2.5 px-3 py-2 rounded-xl text-xs font-semibold cursor-pointer transition-all"
                  style={{ background: "rgba(255,255,255,0.04)", color: "rgba(255,255,255,0.5)", border: "1px solid rgba(255,255,255,0.08)" }}
                  onMouseEnter={e => { e.currentTarget.style.background = "rgba(255,255,255,0.08)"; e.currentTarget.style.color = "#fff"; e.currentTarget.style.borderColor = "rgba(255,255,255,0.16)"; }}
